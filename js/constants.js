...
const BOARD_THEMES = {
  ...
  wood:    { '--board-bg': '#3a2208', '--cell-bg': '#8b6343', '--cell-hover-bg': '#9b7253' },
  blue:    { '--board-bg': '#122d50', '--cell-bg': '#235280', '--cell-hover-bg': '#2e639a' },
  ...
  sky:     { '--board-bg': '#046eab', '--cell-bg': '#5aa6c9ff', '--cell-hover-bg': '#b3e5fc' },
};
